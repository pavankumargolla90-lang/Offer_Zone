            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="was-validated">
                        ...
                        <textarea class="form-control" id="formContent" name="content" rows="5"
                            placeholder="Enter your detail content here..." required=""></textarea>
                        <div class="invalid-feedback">Please enter your content message.</div>
                        <div class="valid-feedback">Looks good!</div>
                    </div>
                </div>
            </div>
